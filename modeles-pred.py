...
dfn=pd.read_csv('C:/Users/liore/Documents/Streamlit/Streamlit/df_nettoye.csv', sep=",")
dfn = dfn.drop(columns=['Unnamed: 0','Eolien (MW)','Solaire (MW)','Hydraulique (MW)','Bioénergies (MW)','Production (MW)'])
dfp=pd.read_csv('C:/Users/liore/Documents/Streamlit/Streamlit/df_test.csv', sep=",")
