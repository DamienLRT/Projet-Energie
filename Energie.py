...
if page == pages[3] : 
  ...
  st.write("La production d’énergie différe selon les régions. Certaines régions produisent de façon quasi-exclusive de l'électricité à partir d’énergie renouvelable, tandis que d'autres ont une grosse production nucléaire.")
  ...
  st.write('##### Quel lien entre consommation d’énergie et la température ?')
  temperature = dfn
  ...
  st.write('Des tests ont permis de confirmer certains liens entre les variables. Le test Anova a été choisi pour étudier une intéraction entre une variable catégorielle et une variable continue. Voici les liens observés :')
  st.markdown('''
...
if page == pages[5] : 
  ...
  st.write("En calculant simplement les moyennes des consommations journalières par région, il possible d'obtenir des résultats proches du machine learning. En réalisant ces moyennes sur 10 ans, nous avons testé ce modèle sur le même jeu de test que précédemment et voici le résultat :")
